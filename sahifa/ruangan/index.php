                            ...
                            <form id="form-tambah">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="contoh: A.1" type="text" class="form-control" name="ruang" id="ruang"/>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="gedung">Nama Gedung</label>
                                        <?php echo dropdown("app_gedung", "gedung", ""); ?>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="kapasitas">Kapasitas</label>
                                        <input placeholder="contoh: 20" type="number" class="form-control" name="kapasitas" id="kapasitas"/>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
