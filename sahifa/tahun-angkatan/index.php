...
<div data-title="<?php echo $admintitle; ?>">
    ...
    <div class="box box-primary">
        ...
        <!-- form start -->
        <div class="box-body" >
            <table id="tabel-angkatan" data-role="table" class="table stripe table-hover ui-responsive">
                <thead>
                    <tr>
                        <th width="5%">NO.</th>
                    ...
                    <div class="modal-body">
                        <form id="form-tambah">
                            <div class="form-group">
                                ...
                                <input placeholder="contoh: 2016-2017" type="text" class="form-control" name="angkatan" id="angkatan"/>
                            </div>
                            <div class="form-group">
    ...
    <script>
        function fetch_data() {
            var outTable = $('#tabel-angkatan').dataTable();
            $.ajax({
                ...
                success: function (s) {
                    ...
                    {
                        outTable.fnAddData([i + 1, s[i][0], s[i][1], s[i][2]]);
                    } // End For
                    outTable.fnSort([[3, 'desc']]);
                },
                error: function (e) {
        ...
        $(function () {
            fetch_data();
            $("#tabel-angkatan").on("click", ".tombol-hapus", function (e) {
            ...
            $("#tabel-angkatan").on("click", ".tombol-edit", function (e) {
                e.preventDefault();
                var angkatan = $(this).attr("angkatan");
                $("#edit").modal('show');
                $(".modal-edit").html($("#overlay").html());
                $.ajax({
                    url: "data/proses.php?edit-form=" + angkatan,
