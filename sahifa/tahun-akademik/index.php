                            ...
                            <form id="form-tambah">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="contoh: 20161" type="text" class="form-control" name="tahun" id="tahun"/>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="batas">Batas Registrasi</label>
                                        <input placeholder="contoh: 2016-10-05" type="text" class="form-control batas" name="batas" />
                                    </div>
                                </div>
                            </form>
                        </div>
