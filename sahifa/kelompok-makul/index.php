...
$admintitle = "Master Kelompok Matakuliah";
                            ...
                            <form id="form-tambah">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="contoh: MPK" type="text" class="form-control" name="kode" id="kode"/>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="nama">Nama Kelompok Matakuliah</label>
                                        <input placeholder="contoh: Matakuliah Pengembangan Kepribadian" type="text" class="form-control" name="nama" id="nama"/>
                                    </div>
                                </div>
                            </form>
                        </div>
